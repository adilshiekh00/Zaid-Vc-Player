        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    ...
                    InlineKeyboardButton(
                        "💝 ᴅᴇᴠʟᴏᴘᴇʀ", url=f"https://t.me/HARAMI_BACHA_HU_SAMBHAL_KAR")
                ],[
                    InlineKeyboardButton(
                        "👥 ᴏꜰꜰɪᴄɪᴀʟ ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/official_learning_zone"
                    ),
                    InlineKeyboardButton(
                        "📣 ᴏꜰꜰɪᴄɪᴀʟ ᴜᴘᴅᴀᴛᴇꜱ", url=f"https://t.me/offical_learning_zone")
                ],[
                    InlineKeyboardButton(
                        "😈 ᴢᴀɪᴅ ᴏꜰꜰɪᴄɪᴀʟ ɢʀᴘ", url="https://t.me/Lolgrpbc")
                ],[
                    InlineKeyboardButton(
...
async def cbhelp(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""<b>💡 Hello there, welcome to the help menu Powered by @official_learning_zone !</b>
...
async def cbhelps(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""<b>💡 Hello there, welcome to the help menu powered by @HARAMI_BACHA_HU_SAMBHAL_KAR !</b>
